...
def sample_once(roi_dict, key, label, choice_list, args):
    ...
    while len(mz_vals) == 0:
        ...
        mz_vals, intensity_vals = extract_example(roi_dict[key][roi_idx], args.min_length, args.max_length, label)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--peakonly_path', dest='peakonly_path', default=DEFAULT_PEAKONLY_PATH, type=str)
    ...
    parser.add_argument('--output_file_name', dest='output_file_name', type=str, default='training_items.json')
