...
#         self.drift = self.get_drift(param_dict)
#         self.adjusted_dataset = self.rt_adjustment()
#
#     def _get_drift(self, param_dict):
#         NotImplementedError()
#
#     def rt_adjustment(selfsarezxd):
#         NotImplementedError()
#
#     def get_dataset(self):
#         return self.adjusted_dataset
#
#     def get_chemical(self, idx):
#         return self.adjusted_dataset[idx]
#
#     def plot_drift(self):
#         chem_rts = [chem.rt for chem in self.dataset]
#         rt_range = (min(chem_rts), max(chem_rts))
#         NotImplementedError()
#
#     def plot_drift_distribution(self):
#         NotImplementedError() # plot samples of the drift function based on the param_dicts
#
#
...
#
#     def rt_adjustment(self, param_dict):
#         return self.dataset
#
#
# class GaussianProcessColumn(Column):
#     def __init__(self, dataset, rbf_params, intercept_params, linear_params):
#         # construct a param_dict
#         param_dict = rbf_params
...
class GaussianProcessColumn(object):
    def __init__(self, dataset, rbf_params, intercept_params, linear_params, noise_sd):
        self.dataset = dataset
