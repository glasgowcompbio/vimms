...
if __name__ == '__main__':
    ...
    if ext.lower() == '.mzml':
        ...
        for input_file_name in input_file_names:
            ...
            logger.warning("Loaded {} MS2 spectra from {}".format(len(file_spectra), input_file_name))
    ...
    for input_file_name in query_spectra.keys():
        ...
        for spec_id in tqdm(file_spectra.keys()):
            for library in spec_libraries:
                hits = spec_libraries[library].spectral_match(file_spectra[spec_id], score_thresh=args.score_thresh,
