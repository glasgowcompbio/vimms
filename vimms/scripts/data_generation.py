...
if __name__ == '__main__':
    ...
    parser.add_argument('--min_ms1_sampling_intensity', dest='min_ms1_sampling_intensity', default=1e3, type=float)
    parser.add_argument('--max_ms1_sampling_intensity', dest='max_ms1_sampling_intensity', default=1e9, type=float)
